...
SDL_Texture* CreateTextureForImage( SDL_Renderer* renderer, const graphics101::Image& image ) {
    SDL_Texture* tex = SDL_CreateTexture( renderer, SDL_PIXELFORMAT_RGBA8888, SDL_TEXTUREACCESS_STATIC, image.width(), image.height() );
...
int main( int argc, const char* argv[] ) {
    ...
    while( !done ) {
        ...
        // 2. Our window.
        {
            ...
            ImGui::SliderInt("Radius", &new_state.radius, 0, 100 );
        ...
        SDL_RenderCopy( renderer, airbrush_tex, nullptr, nullptr );
